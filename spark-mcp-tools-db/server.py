...
def find_apartments(
    ...
    输入参数 (parameters):
        ...
        return_fields (Union[str, List[str]]): 指定要返回的字段列表。
            如果为 None，则返回所有默认字段。
            可选字段: '房号', '楼栋', '楼层', '房型', '面积(平方米)', '朝向', '参考月租金', '租金说明'。
    ...
    find_apartments(building_no=['A'],floor_range=(15, 100),orientation=['南'],room_code_desc=['一房'],price_range=(0, 25000),sort_by='area_sqm',sort_order='desc',return_fields = ['房号', '面积(平方米)', '参考月租金', '朝向'])
